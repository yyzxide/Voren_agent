...
6. Stop at the approval boundary. Do not treat proposing an action as executing it.
7. Claim completion only after a verified receipt confirms the final world state.
